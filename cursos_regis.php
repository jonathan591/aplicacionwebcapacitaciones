...
<head>
    ...
    <title>Registro Curso | El Laurel</title>
...
?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-fw fa-file"></i> Registro de Cursos</h1>
                    ...
                    <div class="row">
                      ...
                      <button type='button' class="btn btn-primary" data-toggle="modal" onclick="NuevoCurso();" ><span class="fas fa fa-solid fa-plus"></span> Registrar curso</button>
                    </div>
...
function NuevoCurso(){
    MostrarModal(0, 'modal/nuevo_curso.php');
}
...
function editarCurso(id){
    //alert(id);
    MostrarModal(id, 'modal/nuevo_curso.php');
}
