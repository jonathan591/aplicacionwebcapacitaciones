                ...
                <form class="form-horizontal" method="post" id="guardar_usuario" name="guardar_usuario">
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <input type="text" id="Nombres"   name="cedula_txt" class="form-control input-sm" value="<?php echo $cedula; ?>" required placeholder="cedula si es estudiante, nombre si es admin"/>
