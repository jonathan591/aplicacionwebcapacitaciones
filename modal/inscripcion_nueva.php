...
if($id>0){
     $color='#63baf1';
    $titulo="Registrar inscripcion al  Curso";
    ...
    if($result!=null){
        if(mysqli_num_rows($result)>0){
            ...
            $cursos=$usuarioA['id_cursos'];
             ...
             $fecha_inicio=$usuarioA['fecha_inicio'];
             $hora_inicio=$usuarioA['hora_inicio'];
              $hora_fin=$usuarioA['hora_fin'];
    ...
    $('#IdUsuario').val(<?php echo $id; ?>);
     $('#guardar_estudiante').bind("submit", function (){
       ...
       $.ajax({
           ...
           url:'ajax/grabar_inscripcion.php',
           data:$(this).serialize(),
           ...
           <div class="modal-body">
                <form  class="form-horizontal" method="post" id="guardar_estudiante" name="guardar_estudiante">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                       ...
                       <select   class="custom-select" id="jornadas" name="cursos_txt" required>
                               <!--<option  value="">Selecionar......................</option>-->
                            <?php
                                $sql_curos="select * from tb_cursos where id_cursos=$id;";
                     ...
                     <div class="form-group">
                        ...
                        <select  class="custom-select"  id="jornadas" name="Jornadas_txt" required>
                            ...
                            <?php
                                $sql_jornadas="select * from tb_jornadas where id_jornadas=$jornada;";
                                $result_jornadas= mysqli_query($objConexion, $sql_jornadas);
                                while($jornadasA=mysqli_fetch_array($result_jornadas)){
                    ...
                    <div class="form-group">
                        ...
                        <input  readonly type="date" class="form-control" name="fecha_inicoo" id="fecha_inic" value="<?php echo $fecha_inicio ?>">
                        </div>
                    </div>
                     <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input  readonly type="time" class="form-control" name="hora_inicoo" id="fecha_inic" value="<?php echo $hora_inicio ?>">
                        </div>
                    </div>
                     <div class="col-lg-12">
                    <div class="form-group">
                        <label for="tipo" class="col-control-label font-weight-bold Negrita"> hora_final</label>
                      
                        <input  readonly type="time" class="form-control" name="hora_fin" id="fecha_inic" value="<?php echo $hora_fin ?>">
                        </div>
                    </div>
                    <?php 
//                    if($idrolUsuario==1){
